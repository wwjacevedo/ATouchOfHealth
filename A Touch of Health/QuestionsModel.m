...
- (void) initQuestionsAndAnswers {
    self.exerciseQuestions = @[@"Eating at least 3 times a day and drinking 8 glasses of water (80z)/day?",
    ...
    self.exerciseAnswers    = [[NSMutableArray alloc] initWithArray:(@[@NO, @NO, @NO, @NO, @NO])];
